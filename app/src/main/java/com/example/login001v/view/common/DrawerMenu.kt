...
import com.example.login001v.view.home.HomeScreen
                ...
                ModalDrawerSheet {
                    ...
                    LazyColumn(
                        ...
                        item {
                            ...
                            DrawerItem(Icons.Default.BakeryDining, "Mousse de Chocolate") {
                                navigateToProduct("Mousse de Chocolate", "5000", navController, scope, drawerState)
                            }
                        }
                        item {
                            DrawerItem(Icons.Default.BakeryDining, "Tiramisú Clásico") {
                        ...
                        item {
                            DrawerItem(Icons.Default.BakeryDining, "Empanada de Manzana") {
                                navigateToProduct("Empanada de Manzana", "3000", navController, scope, drawerState)
                            }
                        }
                        item {
                            DrawerItem(Icons.Default.Coffee, "Café del Día") {
